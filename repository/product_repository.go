...
type ProductRepository interface {
	...
	// // Product SKU Details
	// SaveProductSkuDetails(db *gorm.DB, skuDetails []entity.ProductSkuDetail) error
	// DeleteProductSkuDetails(db *gorm.DB, productSkuId uuid.UUID, skuDetails []entity.ProductSkuDetail) error
